	...
	factory: (require) => {
		...
		const CHANNELS = [
			...
			},
			{
				...
				statusPath: "/openclaw-bridge/channels/qq/status",
				loginPath: "/openclaw-bridge/channels/qq/login",
				logoutPath: "/openclaw-bridge/channels/qq/logout",
				verifyPath: "",
				validatePath: "/openclaw-bridge/channels/qq/validate",
				whitelistPh: "openid1,openid2",
				fields: [
					{ key: "qqBotAppId", label: "机器人 AppID", ph: "开放平台申请的 AppID", secret: false },
					{ key: "qqBotToken", label: "机器人 Token", ph: "留空保存 = 保持现状", secret: true }
				],
				sandboxKey: "qqSandbox"
			}
		];
